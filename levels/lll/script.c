...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_BULLY_BOSS, -6220, 409, 5754, 0, 0, 0, (0 << 24), bhvBigBully),
		...
		OBJECT(MODEL_BULLY, -4000, -273, 5679, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_NONE, -4485, 47, 4112, 0, 37, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_LLL_ROLLING_LOG, 1154, 552, -2663, 0, -136, 0, 0x00000000, bhvPushableRollingLog),
		MARIO_POS(0x01, 0, 1558, -910, 5552),
		OBJECT(MODEL_NONE, -5854, -562, -2754, 0, 0, 0, (11 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -1761, -942, 5569, 0, 90, 0, 0x00000000, bhvLllBowserPuzzle),
		OBJECT(MODEL_LLL_SINKING_ROCK_BLOCK, 1563, -1144, 3884, 0, 0, 0, 0x00000000, bhvLllSinkingRockBlock),
		OBJECT(MODEL_LLL_SINKING_ROCK_BLOCK, -2271, -949, -2329, 0, -75, 0, 0x00000000, bhvLllSinkingRockBlock),
		OBJECT(MODEL_LLL_SINKING_ROCK_BLOCK, -3687, -947, -1881, 0, -38, 0, 0x00000000, bhvLllSinkingRockBlock),
		OBJECT(MODEL_LLL_SINKING_ROCK_BLOCK, -4822, -938, -1382, 0, -140, 0, 0x00000000, bhvLllSinkingRockBlock),
		OBJECT(MODEL_NONE, -1761, -942, 5569, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -1761, -942, 4884, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -1761, -942, 6255, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -1040, -942, 5569, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -1040, -942, 4884, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -1040, -942, 6255, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -2414, -942, 5569, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, -2414, -942, 6255, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, 2218, -276, -429, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, 1628, 87, -1030, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -3489, -216, -4548, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -2987, -648, 5569, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -4432, 17, -4442, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -5152, 266, -5181, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -5914, 1074, -5811, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -6554, 1463, -6131, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -6449, 1927, -5448, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
	...
	AREA(2, lll_area_2),
		...
		OBJECT(MODEL_LAVA_DOOR, 0, 4023, 3112, 0, 0, 0, 0x00000000, bhvDoorCustom),
		OBJECT(MODEL_LAVA_FLOOR, 0, -121, 0, 0, 0, 0, 0x00000000, bhvRisingLava),
		OBJECT(MODEL_NONE, 0, 3400, 3538, 0, 0, 0, 0x00000000, bhvTriggerLava),
